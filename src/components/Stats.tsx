...
/**
 * Stats section. Cyberpunk variant: 2x2 grid with vertical neon dividers
 * between cells, terminal-style value rendering with a slight scan.
 */
        ...
        <section className="tech-grid relative border-y border-border/50 px-4 py-16 md:px-6 md:py-24">
            <div className="mx-auto grid max-w-7xl items-start gap-12 lg:grid-cols-5 lg:gap-16">
                ...
                <div className="space-y-6 text-center lg:col-span-2 lg:text-left">
                    ...
                    <h2 className="font-display text-2xl font-bold uppercase leading-tight tracking-wide md:text-4xl">
                        Hello, I&apos;m Fouzia —
                        <br className="hidden md:block" />
                        <span className="cyber-glitch text-gradient-neon-bg" data-text="SOC Analyst">
                            SOC Analyst
                        </span>{" "}
                    ...
                    <p className="font-mono text-sm leading-relaxed text-muted-foreground md:text-base">
                        I hold an{" "}
                        <span className="text-primary">MSc in Computer Networks and Systems Security</span>{" "}
                        and work at the intersection of threat detection, incident response, and
                        systems hardening — protecting enterprise infrastructure from evolving
                        cyber threats.
                    </p>
                    <div className="flex items-center justify-center gap-2 pt-2 font-mono text-[10px] uppercase tracking-[0.2em] text-muted-foreground lg:justify-start">
                ...
                <div className="grid grid-cols-2 divide-x divide-y divide-border/50 border border-border/50 lg:col-span-3 cyber-chamfer">
                    {stats.map((stat, i) => (
                        <div
                            key={i}
                        ...
                        >
                            ...
                            <div className="font-display text-3xl font-black uppercase tracking-tight text-primary text-glow-md md:text-5xl">
                                {stat.value}
                            </div>
                            <div className="font-mono text-[10px] uppercase tracking-[0.18em] text-muted-foreground md:text-xs">
                                {stat.label}
                            </div>
                            {/* Bottom scan accent on hover */}
